...
abstract class ShipDescription implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Persistence\\ShipDescriptionPersistence\\Map\\ShipDescriptionTableMap';
    ...
    /**
     * Initializes internal state of Persistence\ShipDescriptionPersistence\Base\ShipDescription object.
     */
    ...
    /**
     * Compares this with another <code>ShipDescription</code> instance.  If
     * <code>obj</code> is an instance of <code>ShipDescription</code>, delegates to
     * <code>equals(ShipDescription)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ShipDescription The current object, for fluid interface
     */
     ...
     */
    public function setCivilization($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->civilization !== $v) {
            $this->civilization = $v;
            $this->modifiedColumns[ShipDescriptionTableMap::COL_CIVILIZATION] = true;
        }
     ...
     * @return $this|\Persistence\ShipDescriptionPersistence\ShipDescription The current object (for fluent API support)
     */
    public function setDimension($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->dimension !== $v) {
            $this->dimension = $v;
            $this->modifiedColumns[ShipDescriptionTableMap::COL_DIMENSION] = true;
        }
    ...
    public function setShipName($v)
    {
        ...
        if ($this->shipname !== $v) {
            $this->shipname = $v;
            $this->modifiedColumns[ShipDescriptionTableMap::COL_SHIPNAME] = true;
        }
    ...
    public function setShipWeight($v)
    {
        ...
        if ($this->shipweight !== $v) {
            $this->shipweight = $v;
            $this->modifiedColumns[ShipDescriptionTableMap::COL_SHIPWEIGHT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShipDescriptionTableMap::translateFieldName('Civilization', TableMap::TYPE_PHPNAME, $indexType)];
            $this->civilization = (null !== $col) ? (string) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ShipDescriptionTableMap::translateFieldName('Weapon2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weapon2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ShipDescriptionTableMap::translateFieldName('Weapon3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weapon3 = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = ShipDescriptionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Persistence\\ShipDescriptionPersistence\\ShipDescription'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShipDescriptionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ShipDescription::setDeleted()
     * @see ShipDescription::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildShipDescriptionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShipDescriptionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_CIVILIZATION)) {
            $modifiedColumns[':p' . $index++]  = 'civilization';
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_DIMENSION)) {
        ...
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_WEAPON2)) {
            $modifiedColumns[':p' . $index++]  = 'weapon2';
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_WEAPON3)) {
            $modifiedColumns[':p' . $index++]  = 'weapon3';
        }
    ...
    {
        $pos = ShipDescriptionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ShipDescription'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ShipDescription'][$this->hashCode()] = true;
        $keys = ShipDescriptionTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Persistence\ShipDescriptionPersistence\ShipDescription
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setWeapon2($value);
                break;
            case 6:
                $this->setWeapon3($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCivilization($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setWeapon2($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setWeapon3($arr[$keys[6]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Persistence\ShipDescriptionPersistence\ShipDescription The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_CIVILIZATION)) {
            $criteria->add(ShipDescriptionTableMap::COL_CIVILIZATION, $this->civilization);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_DIMENSION)) {
            $criteria->add(ShipDescriptionTableMap::COL_DIMENSION, $this->dimension);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_SHIPNAME)) {
            $criteria->add(ShipDescriptionTableMap::COL_SHIPNAME, $this->shipname);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_SHIPWEIGHT)) {
            $criteria->add(ShipDescriptionTableMap::COL_SHIPWEIGHT, $this->shipweight);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_WEAPON1)) {
            $criteria->add(ShipDescriptionTableMap::COL_WEAPON1, $this->weapon1);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_WEAPON2)) {
            $criteria->add(ShipDescriptionTableMap::COL_WEAPON2, $this->weapon2);
        }
        if ($this->isColumnModified(ShipDescriptionTableMap::COL_WEAPON3)) {
            $criteria->add(ShipDescriptionTableMap::COL_WEAPON3, $this->weapon3);
        }
    ...
    {
        $criteria = ChildShipDescriptionQuery::create();
        $criteria->add(ShipDescriptionTableMap::COL_CIVILIZATION, $this->civilization);
        $criteria->add(ShipDescriptionTableMap::COL_DIMENSION, $this->dimension);
    ...
    {
        $validPk = null !== $this->getCivilization() &&
            null !== $this->getDimension();
    ...
    {
        $this->setCivilization($keys[0]);
        $this->setDimension($keys[1]);
    }
    ...
    {
        return (null === $this->getCivilization()) && (null === $this->getDimension());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Persistence\ShipDescriptionPersistence\ShipDescription (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Persistence\ShipDescriptionPersistence\ShipDescription Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a WeaponDescription object.
     *
     * @param  WeaponDescription $v
     * @return $this|\Persistence\ShipDescriptionPersistence\ShipDescription The current object (for fluent API support)
     * @throws PropelException
     */
    public function setWeaponDescriptionRelatedByWeapon1(WeaponDescription $v = null)
    {
        ...
        if ($v !== null) {
            $v->addShipDescriptionRelatedByWeapon1($this);
        }
    ...
    /**
     * Get the associated WeaponDescription object
     *
    ...
    public function setWeaponDescriptionRelatedByWeapon2(WeaponDescription $v = null)
    {
        ...
        // If this object has already been added to the WeaponDescription object, it will not be re-added.
        if ($v !== null) {
            $v->addShipDescriptionRelatedByWeapon2($this);
        }
    ...
    public function setWeaponDescriptionRelatedByWeapon3(WeaponDescription $v = null)
    {
        ...
        // If this object has already been added to the WeaponDescription object, it will not be re-added.
        if ($v !== null) {
            $v->addShipDescriptionRelatedByWeapon3($this);
        }
    ...
    {
        return (string) $this->exportTo(ShipDescriptionTableMap::DEFAULT_STRING_FORMAT);
    }
